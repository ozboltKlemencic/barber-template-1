  ...
  return (
    <div>
      ...
      >
        ...
        <span className="bg-white rotate-[120deg] shadow-white-light absolute left-[-400%] w-40 h-[40px] opacity-50 group-hover/insta:left-[50%] duration-500 ease-in-out shadow-[0_0_10px_10px_rgba(0,0,0,0.3)]"></span>
      </Link>
    </div>
  );
};
