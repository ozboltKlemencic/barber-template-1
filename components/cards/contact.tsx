...
export default function ContactInfo() {
  return (
    <div className="bg-black p-8 border-2 border-[#FFD700]/30 max-w-md relative">
      ...
      <div className="absolute top-0 left-0 w-8 h-8 border-l-2 border-t-2 border-[#FFD700]/[0.6] -translate-x-[1px] -translate-y-[1px]" />
      <div className="absolute top-0 right-0 w-8 h-8 border-r-2 border-t-2 border-[#FFD700]/[0.6] translate-x-[1px] -translate-y-[1px]" />
      <div className="absolute bottom-0 left-0 w-8 h-8 border-l-2 border-b-2 border-[#FFD700]/[0.6] -translate-x-[1px] translate-y-[1px]" />
      <div className="absolute bottom-0 right-0 w-8 h-8 border-r-2 border-b-2 border-[#FFD700]/[0.6] translate-x-[1px] translate-y-[1px]" />
