        ...
        <CardBody className=" relative group/card  hover:shadow-2xl hover:shadow-yellow-200/[0.1] bg-black border-yellow-200/[0.2]  w-auto sm:w-[25rem]  h-auto p-1 border  ">
          <CardItem translateZ="10" className="w-full opacity-80 hover:opacity-100">
            <Image
              ...
              height="1000"
              width="1000"
              className="h-[32rem] w-full object-cover  group-hover/card:shadow-xl"
              alt="thumbnail"
            />
          </CardItem>
          <div className="absolute bottom-2 left-2 right-2 flex justify-between items-center">
            <CardItem
              translateZ={20}
              as="button"
              className="px-2 py-8 m-1 w-full backdrop-blur-lg bg-black/[0.3] border border-white/[0.05] text-white text-xs font-bold"
            >
