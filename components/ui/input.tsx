  ...
  ({ className, type, ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          "flex h-9 w-full rounded-lg border   px-3 py-2 text-sm  shadow-sm shadow-black/5 transition-shadow focus-visible:outline-none focus-visible:ring-[3px]  disabled:cursor-not-allowed disabled:opacity-50 border-neutral-500 bg-neutral-950 text-neutral-50 placeholder:text-neutral-400/70 focus-visible:border-primary focus-visible:ring-yellow-300/20",
          type === "search" &&
