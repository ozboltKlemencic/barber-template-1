...
const ShinyText = ({ text, disabled = false, speed = 5, className = "",link="#" }: Props) => {
  return (
    <Link href={link} className='border realative group/shinyBtn border-neutral-700 gold-shadow hover:border-yellow-400 transition-all duration-300 px-2 py-1 w-[6rem] flex items-center justify-center'>
      <div
